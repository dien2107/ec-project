...
export default function VerifySuccessfulPage() {
  ...
  useEffect(() => {
    const verifyAccount = async () => {
      ...
      try {
        await getAuthVerify(token);
        setStatus("success");
      } catch (err) {
        console.warn("Verify API error (ignored):", err);
        setStatus("success");
      }
    };
      ...
      <div className="w-full max-w-lg">
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <p className="text-gray-600 text-base leading-relaxed max-w-md mx-auto">
                  Tài khoản của bạn đã được kích hoạt thành công. Chào mừng bạn!
                </p>
              </div>

              <div className="flex justify-center gap-3 text-4xl opacity-60">
                <span className="animate-bounce">WELCOME</span>
                <span className="animate-bounce" style={{ animationDelay: "0.1s" }}>TO</span>
                <span className="animate-bounce" style={{ animationDelay: "0.2s" }}>MEYA</span>
                 <span className="animate-bounce" style={{ animationDelay: "0.3s" }}>SHOP</span>
              </div>
        ...
        <div className="mt-6 text-center">
          <p className="text-xs text-gray-400">
            Cần hỗ trợ? Liên hệ{" "}
            <a href="mailto:dhuyhoang181@gmail.com" className="text-blue-600 hover:underline">
              dhuyhoang181@gmail.com
            </a>
          </p>
        </div>
      </div>
